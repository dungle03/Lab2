...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_ds.add(new Contact(1,"Le Dinh Dung","0123456789",false));
        list_ds.add(new Contact(2,"Nguyen Quang Anh","0222383832",false));
        list_ds.add(new Contact(3,"Tran Anh Duc","0318271827",false));
